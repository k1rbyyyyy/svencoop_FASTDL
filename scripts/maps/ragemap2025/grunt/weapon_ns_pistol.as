...
//Models
const string szModelP = "models/ragemap2025/grunt/weapons/p_hg.mdl";
const string szModelV = "models/ragemap2025/grunt/weapons/v_hg.mdl";
const string szModelW = "models/ragemap2025/grunt/weapons/w_hg.mdl";
const string szShell = "models/ragemap2025/grunt/weapons/shell.mdl";

//Sounds
const string szSoundPrimaryFire = "ragemap2025/grunt/weapons/hg/hg-1.wav";
const string szSoundDraw = "ragemap2025/grunt/weapons/hg/pistol_draw.wav";
const string szSoundClipIn = "ragemap2025/grunt/weapons/hg/pistol_clipin.wav";
const string szSoundClipOut = "ragemap2025/grunt/weapons/hg/pistol_clipout.wav";
const string szSoundSlideRelease = "ragemap2025/grunt/weapons/hg/pistol_slide_release.wav";
...
class weapon_ns_pistol : ScriptBasePlayerWeaponEntity, NSBASE::WeaponBase
{
	...
	{	
		...
		if( self.m_iClip == 0 )
			Reload( MAX_CLIP, RELOAD_EMPTY, flReloadTimeEmpty, flReloadTimeEmpty, GetBodygroup() );
		else
			Reload( MAX_CLIP, RELOAD, flReloadTime, flReloadTime, GetBodygroup() );
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_ns_pistol", "ragemap2025/grunt", "9mm", "", "ammo_9mmclip" );
}
}