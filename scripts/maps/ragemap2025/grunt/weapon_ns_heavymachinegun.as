...
//Models
const string MODEL_P = "models/ragemap2025/grunt/weapons/p_hmg.mdl";
const string MODEL_V = "models/ragemap2025/grunt/weapons/v_hmg.mdl";
const string MODEL_W = "models/ragemap2025/grunt/weapons/w_hmg.mdl";
const string MODEL_SHELL = "models/ragemap2025/grunt/weapons/shell.mdl";

//Sounds
const string SND_FIRE = "ragemap2025/grunt/weapons/hmg/hmg-1.wav";
const string SND_DRAW = "ragemap2025/grunt/weapons/hmg/hmg_draw.wav";
const string SND_CLIP_IN = "ragemap2025/grunt/weapons/hmg/hmg_clipin.wav";
const string SND_CLIP_OUT = "ragemap2025/grunt/weapons/hmg/hmg_clipout.wav";
const string SND_CLOSE = "ragemap2025/grunt/weapons/hmg/hmg_close.wav";
const string SND_OPEN = "ragemap2025/grunt/weapons/hmg/hmg_open.wav";
const string SND_SLIDE = "ragemap2025/grunt/weapons/hmg/hmg_slide.wav";
...
//Anim timings
const float DEPLOY_TIME = 1.05f;
const float RELOAD_ANIM_TIME = 7.32;
const float RELOAD_TIME = 6;
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_ns_heavymachinegun", "ragemap2025/grunt", "556", "", "ammo_556clip" );
}
}