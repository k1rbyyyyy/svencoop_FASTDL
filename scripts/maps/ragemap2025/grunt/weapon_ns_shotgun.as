...
//Models
const string szModelP = "models/ragemap2025/grunt/weapons/p_sg.mdl";
const string szModelV = "models/ragemap2025/grunt/weapons/v_sg.mdl";
const string szModelW = "models/ragemap2025/grunt/weapons/w_sg.mdl";
const string szShell = "models/ragemap2025/grunt/weapons/shotshell.mdl";

//Sounds
const string szSoundPrimaryFire = "ragemap2025/grunt/weapons/sg/sg-1.wav";
const string szSoundReload = "ragemap2025/grunt/weapons/sg/shotgun_reload.wav";
const string szSoundDraw = "ragemap2025/grunt/weapons/sg/shotgun_draw.wav";
const string szSoundPump = "ragemap2025/grunt/weapons/sg/shotgun_pump.wav";
const string szSoundCock = "ragemap2025/grunt/weapons/sg/sg-cock.wav";
const string szSoundStockRelease = "ragemap2025/grunt/weapons/sg/shotgun_stock_release.wav";
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_ns_shotgun", "ragemap2025/grunt", "buckshot", "", "ammo_buckshot" );
}
}