...
//Models
const string MODEL = "models/ragemap2025/grunt/monsters/fade.mdl";

//Sounds
const string FADE_SOUND_LEAP = "ragemap2025/grunt/monsters/fade/blinksuccess.wav";
const string FADE_SOUND_LEAP_HIT = "ragemap2025/grunt/monsters/skulk/leaphit1.wav";
const string FADE_SOUND_ATTACK1 = "ragemap2025/grunt/monsters/fade/claws1.wav";
const string FADE_SOUND_ATTACK2 = "ragemap2025/grunt/monsters/fade/claws2.wav";
const string FADE_SOUND_ATTACK3 = "ragemap2025/grunt/monsters/fade/claws3.wav";
const string FADE_SOUND_DEATH1 = "ragemap2025/grunt/monsters/fade/role6_die1.wav";
const string FADE_SOUND_DEATH2 = "ragemap2025/grunt/monsters/fade/role6_pain1.wav";

const string FADE_SOUND_WOUND1 = "ragemap2025/grunt/monsters/fade/role6_wound1.wav";

const string FADE_SOUND_IDLE = "ragemap2025/grunt/monsters/fade/role6_idle1.wav";
const string FADE_SOUND_ALERT = "ragemap2025/grunt/monsters/fade/role6_move1.wav";
const string FADE_SOUND_TAUNT1 = "ragemap2025/grunt/monsters/asay31.wav";
...
class monster_fade : ScriptBaseMonsterEntity
{
	...
	void Spawn()
	{
		...
		self.m_FormattedName = "Psammanthropos sicarius";
		self.MonsterInit();
