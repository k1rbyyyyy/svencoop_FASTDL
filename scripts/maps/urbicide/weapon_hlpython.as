...
* The Half-Life version of the python
  Tweaked to look and sound like vanila python. Also has zoom enabled.
*/
namespace HL_PYTHON2
{
enum python_e
{
	PYTHON_IDLE1 = 0,
...
bool IIsMultiplayer = true;
// Models
string W_MODEL		= "models/w_357.mdl";
string V_MODEL		= "models/v_357.mdl";
string P_MODEL		= "models/p_357.mdl";
// Sprites
...
void Register()
{
	...
	{
		g_CustomEntityFuncs.RegisterCustomEntity( "HL_PYTHON2::weapon_hlpython", GetName() );
