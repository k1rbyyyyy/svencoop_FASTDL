...
class weapon_hlmp5 : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/urbicide/v_9mmAR.mdl" );
		...
		g_SoundSystem.PrecacheSound( "urbicide/weapons/hks1.wav" );
		g_SoundSystem.PrecacheSound( "urbicide/weapons/hks2.wav" );
		g_SoundSystem.PrecacheSound( "urbicide/weapons/hks3.wav" );
