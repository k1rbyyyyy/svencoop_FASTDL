...
class weapon_hlshotgun : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/urbicide/v_shotgun.mdl" );
		...
		g_SoundSystem.PrecacheSound( "urbicide/weapons/dbarrel1.wav" );//shotgun
		g_SoundSystem.PrecacheSound( "urbicide/weapons/sbarrel1.wav" );//shotgun
