...
const int TESLA_DEFAULT_GIVE 		= 40;
	...
	void UpdateLightning3( const Vector& in vecSrc, const Vector& in vecAiming, int iDamage )
	{
		...
		if ( iDamage > 0 )
		{
			if ( tr.pHit !is null )
			{
				...
				if ( pHit !is null )
				{
					// Switched out DMG_GIB_CORPSE with DMG_SHOCK | DMG_ENERGYBEAM.
					// Should stop the Tesla gun from giving NPCs flight capabilities. - H2, 28/03/2024.
					g_WeaponFuncs.ClearMultiDamage();
					pHit.TraceAttack( m_pPlayer.pev, iDamage, vecAiming, tr, DMG_SHOCK | DMG_ENERGYBEAM );
